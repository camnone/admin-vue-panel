<template>
  <Container>
    <div class="table">
      ...
      <TableList @remove="deletePwa" :pwaList="sortedAndSearchedPosts" />
    ...
    <div class="download">
      <div class="papper">
        ...
        <div class="download-text">Drag & Drop File here to upload</div>
      </div>
    </div>
  </Container>
</template>
...
.table {
  &-settings {
    ...
    background-color: rgba(15, 23, 42, 0.7019607843);
    width: 3rem;
    height: 3rem;
    border-radius: 100%;
    color: #fff;
